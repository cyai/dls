...
class Ledger {
    ...
    public:
        ...
        void addTransaction(string prevHash, int txnId, string fromPk, string toPk, double amount, string sign, string newHash);

        // void addTransaction(string prevHash, int txnId, string fromPk, string toPk, double amount, string sign, string newHash) {
        //     Node* newNode = new Node(prevHash, txnId, fromPk, toPk, amount, sign, newHash);
